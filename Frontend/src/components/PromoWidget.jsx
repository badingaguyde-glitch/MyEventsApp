...
const PromoWidget = ({ userPlan }) => {
    ...
    if (userPlan === 'enterprise') {
        return (
            <div className="fixed bottom-6 right-6 z-50 px-4 py-3 rounded-2xl border border-emerald-500/30 text-emerald-300 text-xs font-black flex items-center gap-2 shadow-2xl bg-slate-900/90 backdrop-blur-md shadow-emerald-500/10">
    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                className={`fixed bottom-6 right-6 z-50 max-w-[360px] rounded-3xl p-6 border shadow-2xl text-left overflow-hidden ${
